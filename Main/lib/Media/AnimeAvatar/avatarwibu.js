...
exports.index = async(req, res, next) => {
    ...
    if (!id || !chu_nen || !chu_ky) return res.jsonp({ 
        error: 'Thiếu tham số bắt buộc',
        usage: 'GET /taoanhdep/avatarwibu/?id=<anime_id>&chu_nen=<background_text>&chu_ky=<signature_text>&color=<color>',
        example: 'GET /taoanhdep/avatarwibu/?id=4&chu_nen=sumibot&chu_ky=sumi&color=pink'
    });
