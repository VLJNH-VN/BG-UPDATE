        ...
        if (!link) return res.json({ 
            ...
            parameters: {
                required: {
                    type: {
                        type: "string",
                        description: "Loại thao tác (upload hoặc get)",
                        example: "upload"
                    },
                    link: {
                        type: "string", 
                        description: "URL hình ảnh từ Imgur cần upload",
            ...
            usage: {
                endpoint: "/uploadimg",
                method: "GET",
                example: "/uploadimg?type=upload&link=https://i.imgur.com/example.jpg"
            }
        });
    ...
    if (req.query.type == 'get') {
        ...
        return res.json({
            ...
            usage: {
                ...
                method: "GET",
                examples: [
                    "/uploadimg?type=upload&link=https://i.imgur.com/example.jpg",
                    "/uploadimg?type=get"
                ]
            }
        });
